...
<head>
    ...
    <link href="{{asset('panel/lib/lightbox/css/lightbox.min.css')}}" rel="stylesheet">
...
<div class="container-fluid page-header py-5">
    <h1 class="text-center text-white display-6">
        @if(request()->routeIs('cars.index'))
            Home
        @elseif(request()->routeIs('cars.create'))
            İlan Ver
        ...
        <div class="row g-5">
            <div class="col-lg-3 col-md-6">
                <div class="footer-item">
                    ...
                    <a href="" class="btn border-secondary py-2 px-4 rounded-pill text-danger">Read More</a>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
...
<!-- Back to Top -->
<a href="#" class="btn btn-dark border-3 border-danger rounded-circle back-to-top"><i class="fa fa-arrow-up"></i></a>
...
<script src="{{asset('panel/lib/lightbox/js/lightbox.min.js')}}"></script>
